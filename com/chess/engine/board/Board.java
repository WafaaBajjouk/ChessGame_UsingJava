...
public class Board {
	...
	//Tiles represent the squares 62
    ...
    public Board(Builder builder) {
        ...
        this.white = calculateActivePieces(builder, Alliance.WHITE);
        this.black = calculateActivePieces(builder, Alliance.BLACK);
        this.enPassantPawn = builder.enPassantPawn;
        Collection<Move> whiteStandardMoves = calculateLegalMoves(this.white);
        Collection<Move> blackStandardMoves = calculateLegalMoves(this.black);
...
//    return  The board table tiles
    ...
    public String toString() {
        ...
        for (int i = 0; i < BoardUtils.NUM_TILES; i++) {
            String tileText = prettyPrint(this.board.get(i));
    ...
    public Iterable<Piece> getAllPieces() {
        return Iterables.unmodifiableIterable(Iterables.concat(this.white, this.black));
    }
...
// builder class is for Creating the standard start chess board
//     White to move first
//     return Board
//  
     ...
     */
    private static List<Tile> createboard(Builder boardBuilder) {
...
//    	key is piece position and value is the piece 
